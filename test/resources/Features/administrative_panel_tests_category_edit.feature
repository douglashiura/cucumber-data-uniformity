Feature: Administrative Panel, "Категорії тестів" tab
    ...
    If I logged as administrator or moderator I can add or remove test categories. And I can edit existing test category
    ...
    Scenario: Clicking on "редагувати" button
		...
		When I push on button "редагувати". I see pop-up with information about category which I want to edit
    ...
    Scenario: Clicking on "видалити" button
		...
		When I push on button "видалити". I see pop-up with captha and buttons 		
			|"видалити"		|
        	|"скасувати"	|
    ...
    Scenario: Clicking on "додати категорію" button
        Given a list of test categories with buttons and "додати категорію" button
		When I push on button "додати категорію". I see pop-up with information about category which I want to add
